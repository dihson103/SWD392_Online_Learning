...
interface PropsType {
  handleConfirmDeleteForm: (status: boolean) => () => void
}

export default function ConfirmDelete({ handleConfirmDeleteForm }: PropsType) {
  return (
    <div
    ...
    >
      ...
      <button
        ...
        onClick={handleConfirmDeleteForm(false)}
      >
        No, cancel
      </button>
    </div>
